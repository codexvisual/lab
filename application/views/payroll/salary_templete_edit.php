		...
		<div class="tab-content">
			<div id="edit" class="tab-pane active">
			    <?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered validate')); ?>
					<input type="hidden" name="salary_template_id" value="<?php echo html_escape($template_id); ?>">
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('salary') . " " . translate('grade'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="template_name" value="<?php echo html_escape($template['name']); ?>"  required />
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('basic') . " " . translate('salary'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<input type="number" class="form-control" name="basic_salary" id="basic_salary" value="<?php echo html_escape($template['basic_salary']); ?>" required />
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('overtime'); ?></label>
						<div class="col-md-6">
							<input type="number" class="form-control" name="overtime_rate" value="<?php echo html_escape($template['overtime_salary']); ?>" />
						</div>
					</div>
					<div class="row">
						<div class="col-md-6 mt-lg">
							<section class="panel panel-custom">
								...
								<div class="panel-body">
									<?php if (count($allowances)){ foreach ($allowances as $key => $allowance): ?>
									<input type="hidden" name="allowance[<?php echo $key; ?>][old_allowance_id]" value="<?php echo html_escape($allowance['id']); ?>">
									<div class="row <?php echo ($key > 0 ? 'mt-md' : '') ;?>">
										<div class="col-md-6">
											<input type="text" class="form-control" name="allowance[<?php echo $key; ?>][name]" required value="<?php echo html_escape($allowance['name']); ?>" />
										</div>
										<div class="col-md-6">
											<input type="number" class="allowance form-control" name="allowance[<?php echo $key; ?>][amount]" required value="<?php echo html_escape($allowance['amount']); ?>" />
										</div>
									</div>
									<?php endforeach; }else{ ?>
									<div class="row">
						...
						<div class="col-md-6 mt-lg">
							<section class="panel panel-custom">
								...
								<div class="panel-body">
									<?php if (count($deductions)){ foreach ($deductions as $key => $deduction): ?>
									<input type="hidden" name="deduction[<?php echo $key; ?>][old_deduction_id]" value="<?php echo html_escape($deduction['id']); ?>">
									<div class="row <?php echo ($key > 0 ? 'mt-md' : ''); ?>">
										<div class="col-md-6">
											<input type="text" class="form-control" name="deduction[<?php echo $key; ?>][name]" required value="<?php echo html_escape($deduction['name']); ?>" />
										</div>
										<div class="col-md-6">
											<input type="number" class="deduction form-control" name="deduction[<?php echo $key; ?>][amount]" required value="<?php echo html_escape($deduction['amount']); ?>" />
										</div>
									</div>
									<?php endforeach; }else{ ?>
									<div class="row">
