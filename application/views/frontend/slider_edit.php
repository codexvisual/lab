			    ...
			    <?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered')); ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<span class="error"><?php echo form_error('button_text_1'); ?></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<span class="error"><?php echo form_error('button_url_1'); ?></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<span class="error"><?php echo form_error('button_text_2'); ?></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<span class="error"><?php echo form_error('button_url_2'); ?></span>
						</div>
					</div>
					<div class="form-group">
