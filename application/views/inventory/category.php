<div class="row">
<?php if (get_permission('chemical_category', 'is_add')): ?>
	<div class="col-md-5">
		<section class="panel">
...
<?php if (get_permission('chemical_category', 'is_view')): ?>
	<div class="col-md-<?php if (get_permission('chemical_category', 'is_add')){ echo "7"; }else{echo "12";} ?>">
		<section class="panel">
			<header class="panel-heading">
					...
					<table class="table table-bordered table-hover table-condensed mb-none">
						...
						if (!empty($categorylist)){
							...
							<tr>
								...
								<td>
								<?php if (get_permission('chemical_category', 'is_edit')): ?>
									...
									onclick="getChemicalCategory('<?php echo html_escape($row['id']); ?>')">
										<i class="fas fa-pen-nib"></i>
									</a>
								<?php endif; if (get_permission('chemical_category', 'is_delete')): ?>
