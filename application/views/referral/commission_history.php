...
<section class="panel">
	<header class="panel-heading">
		<h4 class="panel-title"><i class="fas fa-list-ol"></i> <?php echo translate('commission') . " " . translate('list'); ?></h4>
	</header>
	<div class="panel-body">
		<!-- Hidden information for printing -->
		<div class="export_title">Commission Report : <?php echo _d($daterange[0]); ?> To <?php echo _d($daterange[1]); ?></div>
		<table class="table table-bordered table-hover table-condensed tbr-top" cellspacing="0" width="100%" id="table-export">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo html_escape($row['staff_name']); ?> <br> <?php echo translate('id'); ?> : <?php echo html_escape($row['staffid']); ?></td>
					<td><?php echo html_escape($row['patient_name']); ?> <br> <?php echo translate('id'); ?> : <?php echo html_escape($row['patientid']); ?></td>
					...
					<td><?php echo html_escape($currency_symbol . number_format($row['commission'], 2, '.', '')); ?></td>
